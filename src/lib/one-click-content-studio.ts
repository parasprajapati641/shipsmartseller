...
export const STUDIO_FORMAT_SPECS: {
  ...
  {
    key: "meesho_square",
    label: "1. Meesho Square",
    w: 1000,
    h: 1000,
    aspect: "1:1 Square",
    bg: "#FFFFFF",
    desc: "Optimized for Meesho logistics rate slabs",
  },
  {
    key: "amazon_main",
    label: "2. Amazon Main",
    ...
    aspect: "1:1 Square",
    bg: "#FFFFFF",
    desc: "RGB 255 pure white studio requirement",
  },
  {
    key: "flipkart_catalog",
    label: "3. Flipkart Catalog",
    w: 1100,
    h: 1466,
    aspect: "3:4 Portrait",
    bg: "#FFFFFF",
    desc: "High-res Flipkart catalog asset",
  },
  {
    key: "instagram_post",
    label: "4. Instagram Post",
    w: 1080,
    h: 1080,
    aspect: "1:1 Square",
    bg: "#FFFFFF",
    desc: "Social feed product post",
  },
  {
    key: "instagram_story",
    label: "5. Instagram Story",
    w: 1080,
    h: 1920,
    aspect: "9:16 Portrait",
    bg: "#090B14",
    desc: "Full-screen mobile story format",
  },
  {
    key: "facebook_marketplace",
    label: "6. Facebook Marketplace",
    w: 1200,
    h: 1200,
    aspect: "1:1 Square",
    bg: "#FFFFFF",
    desc: "Facebook catalog listing format",
  },
  {
    key: "whatsapp_product",
    label: "7. WhatsApp Product",
    w: 800,
    h: 800,
    aspect: "1:1 Square",
    bg: "#FFFFFF",
    desc: "Mobile instant catalog preview",
  },
  {
    key: "product_banner",
    label: "8. Product Banner",
    w: 1920,
    h: 1080,
    aspect: "16:9 Landscape",
    bg: "#090B14",
    desc: "Wide promotional store banner",
  },
  {
    key: "white_bg_product",
    label: "9. White Background Product",
    w: 1200,
    h: 1200,
    aspect: "1:1 Square",
    bg: "#FFFFFF",
    desc: "Isolated 100% white background asset",
  },
  {
    key: "premium_hd_catalog",
    label: "10. Premium HD Catalog",
    w: 2000,
    h: 2000,
    aspect: "1:1 Square",
    bg: "#FFFFFF",
    desc: "Ultra HD master catalog archive format",
  },
];
