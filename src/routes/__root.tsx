  ...
  head: () => ({
    meta: [
      ...
      { title: "Ship Smart" },
      {
        name: "description",
        content:
          "Cut Meesho shipping charges with AI-optimized product images. Auto-generate white-background, square, marketplace-ready images from 5 KB to 50 KB in seconds.",
      },
      { name: "author", content: "Ship Smart" },
      { property: "og:title", content: "Ship Smart" },
      {
        property: "og:description",
        content:
          "AI-powered image optimization built for Meesho sellers. Reduce shipping costs, boost catalog quality.",
      },
