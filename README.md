...
ShipSmart Seller is an enterprise-grade, AI-powered e-commerce image optimization and catalog intelligence platform. Engineered specifically for sellers on Meesho, Flipkart, Amazon India, Myntra, and global marketplaces, ShipSmart Seller automatically crops products to precise 88%–92% frame occupancy, applies studio-clean white backgrounds, compresses images to target file weight presets (5 KB – 50 KB), and runs real-time listing conversion simulations.
...
- **Build & SSR**: Vite 8 + Nitro Engine + Cloudflare Module
- **Database & Auth**: Supabase
- **Payments**: Razorpay SDK (HMAC-SHA256 Signature Verified)
